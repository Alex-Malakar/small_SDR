...
|---|---|---|
| [FM Receiver](./decode_fm.grc/) | RTL-SDR v3 | WBFM broadcast receiver with audio output and spectrum display |
| [RF Spectrum Analyzer](./spectral_display.grc/) | RTL-SDR v3 | Wideband spectrum analyzer with waterfall display|
